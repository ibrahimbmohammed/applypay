...
export type ExecutiveCreateUpdateMutationInput = {
...
/** Create/ Update an organization Executive */
export type ExecutiveCreateUpdateMutationPayload = {
  __typename?: 'ExecutiveCreateUpdateMutationPayload';
...
export type MeetingCreateUpdateMutationInput = {
  ...
  /** Event logo */
  eventLogo?: InputMaybe<Scalars['String']>;
...
/** Create/ Update a Meeting for an org */
export type MeetingCreateUpdateMutationPayload = {
  __typename?: 'MeetingCreateUpdateMutationPayload';
  ...
  /** Download Certification Condition I */
  downloadCertificateCondition1?: Maybe<Scalars['Boolean']>;
  /** Download Certification Condition II */
  downloadCertificateCondition2?: Maybe<Scalars['Boolean']>;
  ...
  /** Publishing an event makes it accessible for everyone to see/register */
  eventState?: Maybe<Scalars['String']>;
  /** Cover photo/ flyer of the event */
  ...
  mainEvent?: Maybe<Scalars['String']>;
  /** Minute of previous meeting to be read at this meeting */
...
export type MeetingImageUploadMutation = {
  __typename?: 'MeetingImageUploadMutation';
  image?: Maybe<MeetingType>;
  ok?: Maybe<Scalars['Boolean']>;
};
...
export type MeetingType = Node & {
  ...
  payers: ConferencePaymentTypeConnection;
  photoUrl?: Maybe<Scalars['String']>;
  pk: Scalars['ID'];
...
export type OrganizationType = Node & {
  ...
  conferencepaymentSet: ConferencePaymentTypeConnection;
...
export type RootMutation = {
  ...
  /** Create/ Update an organization Executive */
  adminExecutive?: Maybe<ExecutiveCreateUpdateMutationPayload>;
  /** Delete an organization Executive */
  ...
  /** Create/ Update a Meeting for an org */
  meeting?: Maybe<MeetingCreateUpdateMutationPayload>;
  /** Delete a Meeting */
  meetingDelete?: Maybe<MeetingDeleteMutation>;
  /** Create and Update an Meeting Image */
  meetingImage?: Maybe<MeetingImageUploadMutation>;
  /**
   * Create multiple referees for a user of an organization.
   * Note each organization would require a different set of references.
   */
...
export type RootMutationAdminExecutiveArgs = {
  input: ExecutiveCreateUpdateMutationInput;
};
...
export type RootMutationMeetingArgs = {
  input: MeetingCreateUpdateMutationInput;
};
...
export type RootMutationMeetingImageArgs = {
  file?: InputMaybe<Scalars['Upload']>;
...
export type RootQuery = {
  ...
  /** Get all ConferencePaymentType */
  adminEventRegistrations?: Maybe<ConferenceRegistrationTypeConnection>;
...
export type RootQueryAdminEventRegistrationsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  event_Id?: InputMaybe<Scalars['Float']>;
  first?: InputMaybe<Scalars['Int']>;
...
export type TicketType = Node & {
  ...
  org?: Maybe<OrganizationType>;
  pk?: Maybe<Scalars['ID']>;
  ticketPaid: ConferencePaymentTypeConnection;
};
...
export type UserNode = Node & {
  ...
  conferencePayments: ConferencePaymentTypeConnection;
...
export type EditAdminPublicationMutationVariables = Exact<{
  categoryId: Scalars['ID'];
  organizationId: Scalars['ID'];
  title: Scalars['String'];
  file: Scalars['Upload'];
...
export type EditAdminPublicationMutation = {
  __typename?: 'RootMutation';
  adminCreatePublication?: {
    __typename?: 'PublicationCreateMutation';
    success?: boolean | null;
...
export type EditAdminOrgLeaderMutationVariables = Exact<{
  id?: InputMaybe<Scalars['Int']>;
  name?: InputMaybe<Scalars['String']>;
  bio?: InputMaybe<Scalars['String']>;
  photo?: InputMaybe<Scalars['String']>;
...
export type EditAdminOrgLeaderMutation = {
  __typename?: 'RootMutation';
  adminExecutive?: {
    __typename?: 'ExecutiveCreateUpdateMutationPayload';
    id?: number | null;
  ...
  publicationsList?: {
    ...
    edges: Array<{
      ...
      node?: {
        ...
        updated: any;
        abstract: string;
        category?: { __typename?: 'PublicationCategoryType'; name: string } | null;
      } | null;
    } | null>;
    pageInfo: {
      __typename?: 'PageInfo';
  ...
  orgExecutiveList?: {
    ...
    edges: Array<{
      ...
      node?: {
        ...
        email?: string | null;
        bio?: string | null;
        position?: { __typename?: 'LeadershipPositionType'; position: string } | null;
        category?: { __typename?: 'LeadershipCategoryType'; name: string } | null;
      } | null;
    } | null>;
    pageInfo: {
      __typename?: 'PageInfo';
